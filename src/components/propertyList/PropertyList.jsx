...
const PropertyList = () => {
  return (
    <div className="pList">
      ...
      <div className="pListItem">
        <img src="https://r-xx.bstatic.com/xdata/images/xphoto/263x210/45450113.jpeg?k=76b3780a0e4aacb9d02ac3569b05b3c5e85e0fd875287e9ac334e3b569f320c7&o=" alt="" className="pListImg" />
        <div className="pListTitles">
